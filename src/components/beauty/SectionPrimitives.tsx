...
export const reviews = [
  { name: "Екатерина В.", text: "Перманентный татуаж бровей сделала год назад — до сих пор идеально. Светлана настоящий художник!", stars: 5, service: "Перманентный макияж" },
  { name: "Ольга Т.", text: "Наконец нашла мастера, который слышит что я хочу. Брови просто идеальные!", stars: 5, service: "Брови" },
  { name: "Анна М.", text: "Была впервые — влюбилась сразу. Атмосфера, профессионализм, результат. Теперь хожу только к Светлане.", stars: 5, service: "Косметология" },
  { name: "Наталья Р.", text: "Делала перманентный макияж губ — результат превзошёл все ожидания. Очень естественно и красиво!", stars: 5, service: "Перманентный макияж" },
];
