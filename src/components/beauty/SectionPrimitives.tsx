...
export const services = [
  { icon: "Sparkles", title: "Макияж", desc: "Дневной, вечерний, свадебный. Создаю образ, который подчёркивает вашу индивидуальность.", price: "от 3 500 ₽" },
  ...
  { icon: "Leaf", title: "Уход за кожей", desc: "Глубокое очищение, увлажнение и восстановление. Подбираю протоколы индивидуально под ваш тип кожи.", price: "от 4 500 ₽" },
